...
public class EmpClientController {
	...
	public ResponseEntity<EmployeeDto> retrieveByRestController(@PathVariable("id") int id) {
	...
	public ResponseEntity<EmployeeDto> retrieveByFeign(@PathVariable("id") int id) {
